...
/*      pushl      dataToSort__hla_1684(,%ebx,4) */
        .byte      0xff /*  */
        .byte      0x34 /*  */
        .byte      0x9d /*  */
...
LblLoop__hla_1694:
        call       STDOUT_NEWLN
/*      cmpl       $0, lastIndex__hla_1682 */
        .byte      0x83 /*  */
        .byte      0x3d /*  */
        .long      lastIndex__hla_1682
        .byte      0x0 /*  */
        jng        LblEnd__hla_1695
/*      mov        dataToSort__hla_1684, %eax */
        .byte      0xa1 /*  */
        .long      (dataToSort__hla_1684+0)
/*      movl       $0, maxIndex__hla_1683 */
        .byte      0xc7 /*  */
        .byte      0x5 /*  */
...
/*      cmpl       %eax, dataToSort__hla_1684(,%ebx,4) */
        .byte      0x39 /*  */
        .byte      0x4 /*  */
        .byte      0x9d /*  */
        .long      dataToSort__hla_1684
        jng        Lblinc__hla_1699
/*      mov        dataToSort__hla_1684(,%ebx,4), %eax */
        .byte      0x8b /*  */
        .byte      0x4 /*  */
        .byte      0x9d /*  */
        .long      dataToSort__hla_1684
/*      mov        %ebx, maxIndex__hla_1683 */
        .byte      0x89 /*  */
        .byte      0x1d /*  */
        .long      maxIndex__hla_1683
...
/*      decl       %ebx */
        .byte      0x4b /*  */
/*      mov        dataToSort__hla_1684(,%ebx,4), %ecx */
        .byte      0x8b /*  */
        .byte      0xc /*  */
        .byte      0x9d /*  */
        .long      dataToSort__hla_1684
/*      mov        %eax, dataToSort__hla_1684(,%ebx,4) */
        .byte      0x89 /*  */
        .byte      0x4 /*  */
        .byte      0x9d /*  */
        .long      dataToSort__hla_1684
/*      mov        maxIndex__hla_1683, %edx */
        .byte      0x8b /*  */
        .byte      0x15 /*  */
        .long      maxIndex__hla_1683
/*      mov        %ecx, dataToSort__hla_1684(,%edx,4) */
        .byte      0x89 /*  */
        .byte      0xc /*  */
        .byte      0x95 /*  */
        .long      dataToSort__hla_1684
/*      decl       lastIndex__hla_1682 */
        .byte      0xff /*  */
        .byte      0xd /*  */
        .long      lastIndex__hla_1682
/*      mov        $0, %ebx */
